...
${TESTDIR}/tests/ChainTestClass.o: tests/ChainTestClass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ChainTestClass.o tests/ChainTestClass.cpp


${TESTDIR}/tests/ChainTestRunner.o: tests/ChainTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ChainTestRunner.o tests/ChainTestRunner.cpp
...
${OBJECTDIR}/Chain_nomain.o: ${OBJECTDIR}/Chain.o Chain.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Chain_nomain.o Chain.cpp;\
	else  \
